...
print('''
    ...
    ===============================
    ''')
print('<1>. Total de Megavatios de Plantas y Ciudades ')
print('<2>. Total de Energia por Ciudad ')
print('<3>. Dinero Recaudado por Region ')
print('<4>. Escriba (salir) para terminar el programa')
...
#megavatios de consumos para dicha ciudad en dicha planta.
    ...
    n_planta = input('Ingrese una planta: ')

    if n_planta == 'Coca Codo Sinclair':
        n_ciudad = input('Ingrese una ciudad: ')
        ...
        if n_ciudad == 'Quito':
            ...
            print("No existe aquella ciudad para la planta de Coca Codo")
    print()
...
#no debería aparecer en el nuevo diccionario  
    ...
    n_ciudad2 = input('Ingrese una ciudad: ')
...
#región
    ...
    n_region = input('Ingrese una Región: ')
